...
from utils_Blink import load_dataset
...
parser.add_argument('--dropout', type=float,nargs='+',  default=0.1,   #0,  1e-1,1e-2, 1e-3,0.5
                    help='Dropout rate (1 - keep probability).')
parser.add_argument('--hidden', type=int, default=16,  # ✅
                    help='Number of hidden units.')
parser.add_argument('--epsilon', type=float, nargs='+', default=[8],  #1,2,3,4,5,6,7,8
                    help='epsilon.')
parser.add_argument('--delta', type=float, nargs='+', default=[0.1,0.9],  #0.1,0.3,0.5,0.7,0.9
...
with open('output_results_Blink.txt', 'a') as f:
    print("******************************************************************************", file=f)
